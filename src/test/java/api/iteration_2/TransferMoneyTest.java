...
public class TransferMoneyTest extends BaseTest {
  ...
  public void userCanTransferMoneyToHisAccount() {
    ...
    UserSteps.transferMoney(
        userRequest,
        accountInfoResponse1,
        accountInfoResponse2,
        transferAmount,
    ...
    AccountInfoResponse accountInfoResponse1Updated =
        UserSteps.updateAccount(accountInfoResponse1, listOfAccounts);
    AccountInfoResponse accountInfoResponse2Updated =
        UserSteps.updateAccount(accountInfoResponse2, listOfAccounts);
    ...
    Assertions.assertEquals(
        newBalance1,
        accountInfoResponse1Updated.getBalance(),
        0.001,
        "Баланс после перевода не совпадает");

    // Проверяем что на счете 2 появилась новая сумма
    Assertions.assertEquals(
        newBalance2,
        accountInfoResponse2Updated.getBalance(),
        0.001,
        "Баланс после перевода не совпадает");
  }
  ...
  public void userCanNotTransferMoneyToHisOwnAccount() {
    ...
    Assertions.assertEquals(
        accountInfoResponse1.getBalance(),
        accountInfoResponse1Updated.getBalance(),
        0.001,
        "Баланс после перевода не совпадает");
  }
  ...
  public void userCanNotTransferMoneyIfSumInTheAccountNotEnough() {
    ...
    // Проверяем что на счете 2 появилась новая сумма
    Assertions.assertEquals(
        accountInfoResponse2.getBalance(),
        accountInfoResponse2Updated.getBalance(),
        0.001,
        "Баланс после перевода не совпадает");
  }
